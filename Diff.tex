...
Now assume the hypothesis, we want to prove that \[ |x_{n+2}(t) - x_{n+1}(t)| = \]
\end{proof}
...
Not all Cauchy sequences converge. As an example, take \[ \mathscr{X} = \mathbb{Q}, d(q,\tilde{q}) = |q- \tilde{q}| \]
