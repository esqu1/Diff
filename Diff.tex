...
Define $\mathbb{R}^+ = \{(s,N,d_1,d_2,\dots) \ | \ s = +1\}$ (positive reals)\\
Write $x = N.d_1d_2d_3\dots$ and $y = M.e_1e_2e_3\dots$. \\
If $x,y \in \mathbb{R}^+$, then $x<y$ if either $N < M$ or $N =M$ and $d_1 < e_1$ or $N = M$, $d_1 = e_1$ and $d_2 < e_2$, or... \\ \\
$0<x$ if $x \in \mathbb{R}^+$, and $x < 0$ if $x \in \mathbb{R}^+$, and $x<y$ if $x \in \mathbb{R}^-, y \in \mathbb{R}^+$. 

\[ -(s,N,d_1,d_2,\dots) = (-s,N,d_1,d_2) \]

Then if $x,y \in \mathbb{R}^-$, and $x<y$ if $-y < -x$
